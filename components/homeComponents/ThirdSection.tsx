    ...
    <section className="flex flex-col md:flex-col 2xl:flex-row lg:flex-col  mt-12 md:mt-28 gap-10 md:gap-20 items-center justify-center px-4">
      ...
      <div className="flex flex-col justify-center w-full 2xl:w-1/2 2xl:mr-40 lg:px-10 md:px-10"> 
        <div className="max-w-full md:max-w-7xl lg:max-w-6xl">
          ...
          <ul className="text-[#383737] mt-4 text-[16px] sm:text-[18px] md:text-[18px] leading-relaxed">
            <li>
              <span className="font-bold italic">✔	Boost Your Revenue, Not Your Stress: </span>
              The whole point of business plan and proposal writing is to grow your bottom line, right? We get it. Our skilled team is here to make sure your proposal isn&apost just good—it’s a cash magnet. Get ready to impress and increase those profit margins without the extra gray hairs. 
            </li>
                        <li>
              <span className="font-bold italic">✔	Clear Goals, Clear Wins:  </span>
              If your proposal doesn’t align with your goals, what&aposs the point? Our US-based business proposal writers will dig deep to understand your business objectives and craft a strategy that hits the bullseye. Whether it&aposs expansion, funding, or world domination, we’ve got your back. 
            </li>
                        <li>
              <span className="font-bold italic">✔ Growth Strategies That Stick: Ready to Scale Up:  </span>
             Whether you&aposre going after a small contract or aiming to scale your business big time, our proposals are built to grow with you. Dreaming of that multi-million-dollar project and Googling “business proposal writers near me”? We’ll help you get there, one proposal at a time. 
            </li>
          </ul>
            <p className="text-[#383737] mt-4 text-[16px] sm:text-[18px] md:text-[18px] leading-relaxed">
