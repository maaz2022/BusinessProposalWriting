        ...
        <div className="max-w-full md:max-w-7xl lg:max-w-6xl">
          ...
          <ul className="text-[#383737] mt-4 text-[16px] sm:text-[18px] md:text-[18px] leading-relaxed">
            <li>
              ...
              If your proposal doesn’t align with your goals, what's the point? Our US-based business proposal writers will dig deep to understand your business objectives and craft a strategy that hits the bullseye. Whether it's expansion, funding, or world domination, we’ve got your back. 
            </li>
                        <li>
